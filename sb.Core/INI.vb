...
Public Class INIDatei
    ...
    Public Function WertLesen(ByVal Sektion As String, ByVal Schlüssel As String, ByVal Pfad As String, Optional ByVal Standardwert As String = "", Optional ByVal BufferSize As Integer = 1024) As String
    ...
    Public Sub WertSchreiben(ByVal Sektion As String, ByVal Schlüssel As String, ByVal Pfad As String, ByVal Wert As String)
        ' Testen, ob ein Pfad zur INI vorhanden ist
        If Pfad = "" Then
    ...
    Public Sub SchlüsselLöschen(ByVal Sektion As String, ByVal Schlüssel As String, ByVal Pfad As String)
        ' Testen, ob ein Pfad zur INI vorhanden ist
        If Pfad = "" Then
    ...
    Public Sub SektionLöschen(ByVal Sektion As String, ByVal Pfad As String)
        ' Testen, ob ein Pfad zur INI vorhanden ist
        If Pfad = "" Then
    ...
    Public Sub BackupAnlegen(ByVal Zielpfad As String, ByVal Pfad As String, Optional ByVal FehlermeldungAnzeigen As Boolean = False)
    ...
    Private Sub DateiLöschen(ByVal Pfad As String, Optional ByVal FehlermeldungAnzeigen As Boolean = False)
        ' Testen, ob ein Pfad zur INI (der Quelldatei) vorhanden ist
        If Pfad = "" Then
            If FehlermeldungAnzeigen = True Then
